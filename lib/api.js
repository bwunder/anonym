...
//it stopped and started in this section when I didn't expect , and we haven't gotten past alert 42 bad cert since 
  ...
  internImages: async () => {
    ...
    try {
      ...
      for (let image of images) {
        // repo old depricate begin Dec18 
        if (image.RepoDigests[0].startsWith(`${config.docker.pull.repo}@`)||image.RepoDigests[0].startsWith(`${config.docker.pull.oldrepo}@`)) {
