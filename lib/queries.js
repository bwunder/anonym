...
procedures: `
  ...
  `,
badSyntax_invalidObject: `SELECT top 1 battle FROM sys.conflagrations`,
badSyntax_null: `NULL`,
advancedOptions: `
...
dmvs: `
    ...
    ORDER BY name
  `,
badSyntax_misspelling: `SELETC @@OPTIONS AS [@@OPTIONS]`,
memoryAvailable: `
...
clusterNodes: `
  ...
  `,
badSyntax_notSQL: `Put the lime in the coconut`,
memoryDumps: `
