...
log('info', `datestamp ${datestamp} new Date(state.FinishedAt) ${new Date(state.FinishedAt)}`)
                  if (!state.FinishedAt || datestamp > new Date(state.FinishedAt)) logStream.emit('end')
                  break
